...
class MiApp(QtWidgets.QMainWindow):
    def __init__(self):
        ...
        video_icon_his.addPixmap(QtGui.QPixmap(Vpath+"\play-button.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
...
###############################################################
    ...
    def run(self):
        ...
        while True:
            ...
            parent_dir = rf"C:\Users\Bebo\Desktop\final_project\icons\videos"
