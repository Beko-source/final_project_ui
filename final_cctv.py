...
"}")
        ...
        self.label_2.setPixmap(QtGui.QPixmap(QtGui.QPixmap(Fpath+"\cctv-logo.svg")))
...
"}")
       ...
       #create slider
        ...
        self.labelDuration_test = QLabel()
        self.labelDuration_test.setMaximumHeight(50)
        self.labelDuration_test.setStyleSheet("color : #FFFFFF")
        ...
        self.hboxLayout.addWidget(self.labelDuration_test)
...
"")
        ...
        self.frame_btlist_s.setStyleSheet("QListView{\n"
"font:87 15pt \"#FFFFFF\";\n"
"color:rgb(255, 255, 255); \n"
"}\n")
        #################################
        ...
        self.list_view.setRootIndex(self.file_system_model.index(rf'C:\Users\Bebo\Desktop\final_project\icons\videos'))
...
"\n")
        ...
        self.page_vidp_s = QtWidgets.QWidget()
        self.page_vidp_s.setObjectName("page_vidp_s")
        self.verticalLayout_20 = QtWidgets.QVBoxLayout(self.page_vidp_s)
        self.verticalLayout_20.setObjectName("verticalLayout_20")
        self.frame_vidp_s = QtWidgets.QFrame(self.page_vidp_s)
        self.frame_vidp_s.setFrameShape(QtWidgets.QFrame.StyledPanel)
        self.frame_vidp_s.setFrameShadow(QtWidgets.QFrame.Raised)
        self.frame_vidp_s.setObjectName("frame_vidp_s")
        self.verticalLayout_22 = QtWidgets.QVBoxLayout(self.frame_vidp_s)
        self.verticalLayout_22.setObjectName("verticalLayout_22")
        self.label_vid_s = QtWidgets.QLabel(self.frame_vidp_s)
        self.label_vid_s.setObjectName("label_vid_s")
        self.verticalLayout_22.addWidget(self.label_vid_s)
        self.verticalLayout_20.addWidget(self.frame_vidp_s)
        self.stackedWidget_3.addWidget(self.page_vidp_s)
...
"}")
        ...
        self.page_btlist_notifi.setStyleSheet("QListView{\n"
"font:87 15pt \"#FFFFFF\";\n"
"color:rgb(255, 255, 255); \n"
"}\n")
        ...
        self.n_list_view.setModel(self.file_system_model)
        self.n_list_view.setRootIndex(self.file_system_model.index(rf'C:\Users\Bebo\Desktop\final_project\icons\videos'))
        #list_view.clicked.connect(self.on_clicked)
        self.list_view.setEditTriggers(QAbstractItemView.NoEditTriggers)
        ...
        self.page_btlist_his.setStyleSheet("QListView{\n"
"font:87 15pt \"#FFFFFF\";\n"
"color:rgb(255, 255, 255); \n"
"}\n")
        ...
        self.h_list_view.setRootIndex(self.h_file_system_model.index(rf'C:\Users\Bebo\Desktop\final_project\icons\history'))
        #list_view.clicked.connect(self.on_clicked)
