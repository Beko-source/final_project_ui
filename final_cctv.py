...
"\n"
        ...
        self.list_view_folders.setRootIndex(self.file_system_model_folders.index(rf'C:\Users\Bebo\Desktop\final_project\icons\videos'))
...
"\n"
        ...
        self.n_list_view.setRootIndex(self.n_file_system_model.index(rf'C:\Users\Bebo\Desktop\final_project\icons\notification'))
        #list_view.clicked.connect(self.on_clicked)
        self.list_view.setEditTriggers(QAbstractItemView.NoEditTriggers)
